...
polymorph_pixel_tasks = [63,59,56,56,56,56,57,57,57,59,57,57,54]';
mindfuzz_design_tasks = [36,40,40,44,43,41,39,33,35,35,35,35,35]';
...
figure
plot(polymorph_pixel_tasks);
hold on
plot(mindfuzz_design_tasks);
plot(total_design_tasks);
